...
# Adding a constraint that each food item must have at least 1 serving per day

for food in servings:
    diet_problem += servings[food] >= 1, f"Min_1_serving_{food.replace(' ', '_')}"
